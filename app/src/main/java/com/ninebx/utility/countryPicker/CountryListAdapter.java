...
public class CountryListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        cell.layoutCountry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(mContext, "Selected Country is " + country.getName(), Toast.LENGTH_LONG).show();
            }
        });
        return view;
    }
    ...
    static class Cell {
        ...
        static Cell from(View view) {
            ...
            if (view.getTag() == null) {
                ...
                cell.layoutCountry = (LinearLayout) view.findViewById(R.id.rowCountry);
                view.setTag(cell);
                return cell;
            } else {
