 ...
 */
public abstract class CustomPBEParametersGenerator
{
     ...
     * base constructor.
     */
    protected CustomPBEParametersGenerator()
    {
    }
    ...
    public Byte[] getPassword()
    {
        ...
        for( int index = 0; index < password.length; index++ ) {
            passwordBytes[index] = password[index];
        }
            ...
            char[] password)
    {
        ...
        for( index = 0; index < password.length; index++ ) {
            bytePassword[index] = Strings.toUTF8ByteArray(password);
        }*/
