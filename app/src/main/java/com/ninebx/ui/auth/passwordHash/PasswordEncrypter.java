...
public class PasswordEncrypter {
    ...
    public static byte[] customPasswordCrypt( byte[] saltString, char[] password, int hashLength  ) throws InvalidKeySpecException, NoSuchAlgorithmException {
        int iterations = PBKDF2_ITERATIONS;
        byte[] testHash = pbkdf2(password, saltString, iterations, hashLength);
        return testHash;
    }
