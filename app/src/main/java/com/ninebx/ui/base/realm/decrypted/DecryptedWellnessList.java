...
public class DecryptedWellnessList implements Parcelable {
    ...
    @Required
    private String classType = "WellnessList";
    @Required
    ...
    public DecryptedWellnessList(int id, String selectionType, String classType, String listName, String dueDate, Integer detailsId, Boolean isSelected, Date selectedDate, Date createdDate, String created, String modified, Boolean isPrivate, String createdUser) {
        this.id = id;
