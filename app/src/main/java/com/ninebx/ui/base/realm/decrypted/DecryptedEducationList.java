 ...
 */
public class DecryptedEducationList implements Parcelable {
    ...
    @Required
    private String classType = "EducationList";
    @Required
    ...
    public DecryptedEducationList(long id, String selectionType, String classType, String listName, String dueDate, Integer detailsId, Boolean isSelected, Date selectedDate, Date createdDate, String created, String modified, Boolean isPrivate, String createdUser) {
        this.id = id;
    ...
    protected DecryptedEducationList(Parcel in) {
    ...
    public static final Creator<DecryptedEducationList> CREATOR = new Creator<DecryptedEducationList>() {
        @Override
        public DecryptedEducationList createFromParcel(Parcel source) {
            return new DecryptedEducationList(source);
        }

        @Override
        public DecryptedEducationList[] newArray(int size) {
            return new DecryptedEducationList[size];
        }
    };
}
