...
public class DecryptedMemoriesList implements Parcelable {
    ...
    @Required private String classType = "MemoriesList";
    ...
    public DecryptedMemoriesList(int id, String selectionType, String classType, String listName, String dueDate, Integer detailsId, Boolean isSelected, Date selectedDate, Date createdDate, String created, String modified, Boolean isPrivate, String createdUser) {
        this.id = id;
    ...
    public static final Creator<DecryptedMemoriesList> CREATOR = new Creator<DecryptedMemoriesList>() {
        @Override
        public DecryptedMemoriesList createFromParcel(Parcel in) {
            return new DecryptedMemoriesList(in);
        }
