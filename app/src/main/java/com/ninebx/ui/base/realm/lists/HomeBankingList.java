...
public class HomeBankingList extends RealmObject {
    ...
    public HomeBankingList(long id, String selectionType, String listName, String dueDate, Integer detailsId, Boolean isSelected, Date selectedDate, Date createdDate, String created, String modified, Boolean isPrivate) {
        this.id = id;
