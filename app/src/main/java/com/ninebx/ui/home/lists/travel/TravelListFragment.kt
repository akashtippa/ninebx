 ...
 */
class TravelListFragment : FragmentBackHelper() {

    private var mListsAdapter: TravelListsAdapter? = null
    var strAddItem = ""
    var fragmentValue = ""
