package com.ninebx.ui.home.lists.education
 ...
 */
class EducationListFragment : FragmentBackHelper() {

    private var mListsAdapter: EducationListsAdapter? = null
    var strAddItem = ""
    var fragmentValue = ""
...
//        myList.addAll(currentUsers!!)
        var getArrayList: ArrayList<DecryptedEducationList> = getArguments()!!.getSerializable("combineListItemsFetched") as ArrayList<DecryptedEducationList>
    ...
    override fun onBackPressed(): Boolean {
        ...
        if (fragmentValue == "HomeScreen") {
            ...
            transaction.remove(this@EducationListFragment)
            transaction.commit()
            fm.popBackStack()
            fm.popBackStack()
