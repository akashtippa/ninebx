...
internal class InterestListsAdapter(private var myList: ArrayList<DecryptedInterestsList>) : RecyclerView.Adapter<InterestListsAdapter.RecyclerItemViewHolder>() {
    ...
    fun restoreAt(position: Int, iItem: DecryptedInterestsList) {
    ...
    fun notifyData(myList: ArrayList<DecryptedInterestsList>) {
        this.myList = myList
