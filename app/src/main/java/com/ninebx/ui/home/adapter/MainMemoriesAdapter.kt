...
import com.ninebx.R
import com.ninebx.ui.base.realm.decrypted.DecryptedMainMemories
import com.ninebx.ui.base.realm.home.contacts.Contacts
import com.ninebx.ui.home.account.interfaces.MainContactsAdded

internal class MainMemoriesAdapter(private var myList: ArrayList<DecryptedMainMemories>?, private val mainContactsAdded: MainContactsAdded) : RecyclerView.Adapter<MainMemoriesAdapter.RecyclerItemViewHolder>() {
    ...
    fun deleteContact(contact: DecryptedMainMemories) {
    ...
    fun notifyData(myList: ArrayList<DecryptedMainMemories>) {
        this.myList = myList
        notifyDataSetChanged()
    }

    fun getList(): ArrayList<DecryptedMainMemories>? {
        return this.myList
    }

    fun updateContact(contact: DecryptedMainMemories) {
        for(item in myList!!) {
