package com.ninebx.ui.home.lists.interests
 ...
 */
class InterestListFragment : FragmentBackHelper() {

    private var mListsAdapter: InterestListsAdapter? = null
    var strAddItem = ""
    var fragmentValue = ""
...
//        myList.addAll(currentUsers!!)
        var getArrayList: ArrayList<DecryptedInterestsList> = getArguments()!!.getSerializable("combineListItemsFetched") as ArrayList<DecryptedInterestsList>


        mListsAdapter = InterestListsAdapter(getArrayList)
    ...
    override fun onBackPressed(): Boolean {
        ...
        if (fragmentValue == "HomeScreen") {
            ...
            transaction.remove(this@InterestListFragment)
            transaction.commit()
            fm.popBackStack()
            fm.popBackStack()
