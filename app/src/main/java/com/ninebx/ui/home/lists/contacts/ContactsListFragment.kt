package com.ninebx.ui.home.lists.contacts
...
import com.ninebx.ui.base.realm.decrypted.DecryptedContactsList
 ...
 */
class ContactsListFragment : FragmentBackHelper() {

    private var mListsAdapter: ContactListsAdapter? = null
    var strAddItem = ""
    var fragmentValue = ""
...
//        myList.addAll(currentUsers!!)
        var getArrayList: ArrayList<DecryptedContactsList> = getArguments()!!.getSerializable("combineListItemsFetched") as ArrayList<DecryptedContactsList>


        mListsAdapter = ContactListsAdapter(getArrayList)
    ...
    override fun onBackPressed(): Boolean {
        ...
        if (fragmentValue == "HomeScreen") {
            ...
            transaction.remove(this@ContactsListFragment)
            transaction.commit()
            fm.popBackStack()
            fm.popBackStack()
