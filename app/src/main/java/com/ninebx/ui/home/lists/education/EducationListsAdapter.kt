...
internal class EducationListsAdapter(private var myList: ArrayList<DecryptedEducationList>) : RecyclerView.Adapter<EducationListsAdapter.RecyclerItemViewHolder>() {
    ...
    fun restoreAt(position: Int, iItem: DecryptedEducationList) {
    ...
    fun notifyData(myList: ArrayList<DecryptedEducationList>) {
        this.myList = myList
