package com.ninebx.ui.home.fragments.memories
 ...
 */
class MemoriesFragment : FragmentBackHelper() {

    val titleText = "<font color=#263238>nine</font><font color=#FF00B0FF>bx</font>"


    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater!!.inflate(R.layout.fragment_memoriess, container, false)
    }
