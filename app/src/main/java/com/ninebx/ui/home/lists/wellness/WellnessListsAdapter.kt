package com.ninebx.ui.home.lists.wellness
...
import com.ninebx.ui.base.realm.decrypted.DecryptedWellnessList
import com.ninebx.ui.home.lists.SuperSubListFragment
import java.util.ArrayList

internal class WellnessListsAdapter(private var myList: ArrayList<DecryptedWellnessList>) : RecyclerView.Adapter<WellnessListsAdapter.RecyclerItemViewHolder>() {
    ...
    fun restoreAt(position: Int, iItem: DecryptedWellnessList) {
    ...
    fun notifyData(myList: ArrayList<DecryptedWellnessList>) {
        this.myList = myList
