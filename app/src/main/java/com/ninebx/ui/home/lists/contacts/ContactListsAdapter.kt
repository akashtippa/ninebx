...
internal class ContactListsAdapter(private var myList: ArrayList<DecryptedContactsList>) : RecyclerView.Adapter<ContactListsAdapter.RecyclerItemViewHolder>() {
    ...
    fun restoreAt(position: Int, iItem: DecryptedContactsList) {
    ...
    fun notifyData(myList: ArrayList<DecryptedContactsList>) {
        this.myList = myList
