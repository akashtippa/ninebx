 ...
 */
class MemoriesListFragment : FragmentBackHelper() {

    private var mListsAdapter: MemoriesListsAdapter? = null
    var strAddItem = ""
    var fragmentValue = ""
...
//        myList.addAll(currentUsers!!)
        var getArrayList: ArrayList<DecryptedMemoriesList> = getArguments()!!.getSerializable("combineListItemsFetched") as ArrayList<DecryptedMemoriesList>


        mListsAdapter = MemoriesListsAdapter(getArrayList)
    ...
    override fun onBackPressed(): Boolean {
        ...
        if (fragmentValue == "HomeScreen") {
            ...
            transaction.remove(this@MemoriesListFragment)
            transaction.commit()
            fm.popBackStack()
            fm.popBackStack()
