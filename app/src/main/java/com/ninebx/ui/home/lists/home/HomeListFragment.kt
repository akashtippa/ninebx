 ...
 */
class HomeListFragment : FragmentBackHelper() {

    private var mListsAdapter: HomeListsAdapter? = null
    var strAddItem = ""
    var fragmentValue = ""
...
//        myList.addAll(currentUsers!!)
        ...
        mListsAdapter = HomeListsAdapter(getArrayList)
        ...
        val swipeHandler = object : SwipeToDeleteCallback(context!!) {
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                val adapter = rvAddedLists.adapter as HomeListsAdapter
